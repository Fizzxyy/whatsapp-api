...
const makeMessagesSocket = (config) => {
    ...
    const felz = (0, newsletter_1.makeNewsletterSocket)(config);
    const { ev, authState, processingMutex, signalRepository, upsertMessage, query, fetchPrivacySettings, sendNode, groupQuery, groupMetadata, groupToggleEphemeral, newsletterWMexQuery, } = felz;
    ...
    const relayMessage = async (jid, message, { messageId: msgId, participant, additionalAttributes, additionalNodes, useUserDevicesCache, useCachedGroupMetadata, statusJidList }) => {
        ...
        const participants = [];
        const destinationJid = (!isStatus) ? (0, WABinary_1.jidEncode)(user, isLid ? 'lid' : isGroup ? 'g.us' : isNewsletter ? 'newsletter' : isBot ? 'bot' : 's.whatsapp.net') : statusJid;
        ...
        await authState.keys.transaction(async () => {
            ...
            const messageContent = (0, Utils_1.normalizeMessageContent)(message);
            ...
            if (!isNewsletter && buttonType) {
                ...
                const items = (0, WABinary_1.getBinaryNodeFilter)(additionalNodes);
                if (items && items.length > 0) {
                    stanza.content.push(...items);
                }
                else {
            ...
            if (isPerson) {
                ...
                const nodes = (0, WABinary_1.getAdditionalNode)('bot');
                const bots = (0, WABinary_1.getBinaryNodeFilter)(additionalNodes);
                if (bots && bots.length > 0) {
                    stanza.content.push(...bots);
                }
                else {
    ...
    const getButtonType = (msg) => {
        ...
        else if (((_d = (_c = (_b = (_a = msg.interactiveMessage) === null || _a === void 0 ? void 0 : _a.nativeFlowMessage) === null || _b === void 0 ? void 0 : _b.buttons) === null || _c === void 0 ? void 0 : _c[0]) === null || _d === void 0 ? void 0 : _d.name) === 'review_and_pay') {
            return 'review_and_pay';
        }
        else if (((_h = (_g = (_f = (_e = msg.interactiveMessage) === null || _e === void 0 ? void 0 : _e.nativeFlowMessage) === null || _f === void 0 ? void 0 : _f.buttons) === null || _g === void 0 ? void 0 : _g[0]) === null || _h === void 0 ? void 0 : _h.name) === 'review_order') {
            return 'review_order';
        }
        else if (((_m = (_l = (_k = (_j = msg.interactiveMessage) === null || _j === void 0 ? void 0 : _j.nativeFlowMessage) === null || _k === void 0 ? void 0 : _k.buttons) === null || _l === void 0 ? void 0 : _l[0]) === null || _m === void 0 ? void 0 : _m.name) === 'payment_info') {
            return 'payment_info';
        }
        else if (((_r = (_q = (_p = (_o = msg.interactiveMessage) === null || _o === void 0 ? void 0 : _o.nativeFlowMessage) === null || _p === void 0 ? void 0 : _p.buttons) === null || _q === void 0 ? void 0 : _q[0]) === null || _r === void 0 ? void 0 : _r.name) === 'payment_status') {
            return 'payment_status';
        }
        else if (((_v = (_u = (_t = (_s = msg.interactiveMessage) === null || _s === void 0 ? void 0 : _s.nativeFlowMessage) === null || _t === void 0 ? void 0 : _t.buttons) === null || _u === void 0 ? void 0 : _u[0]) === null || _v === void 0 ? void 0 : _v.name) === 'payment_method') {
            return 'payment_method';
        }
        else if (msg.interactiveMessage && ((_w = msg.interactiveMessage) === null || _w === void 0 ? void 0 : _w.nativeFlowMessage)) {
            return 'interactive';
        }
        ...
        sendMessage: async (jid, content, options = {}) => {
            ...
            if (typeof content === 'object' &&
                ...
                if ((0, WABinary_1.isJidGroup)(jid)) {
                    ...
                    const node = await groupQuery(jid, 'get', [{
                            tag: 'query',
                            attrs: { request: 'interactive' }
                        }]);
                    let data = (0, WABinary_1.getBinaryNodeChild)(node, 'group');
                    let exp = (0, WABinary_1.getBinaryNodeChild)(data, 'ephemeral');
                    eph = (_a = exp === null || exp === void 0 ? void 0 : exp.attrs) === null || _a === void 0 ? void 0 : _a.expiration;
                }
                else {
