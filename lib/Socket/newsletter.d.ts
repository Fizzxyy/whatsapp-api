import { SocketConfig, WAMediaUpload, QueryIds, NewsletterMetadata, NewsletterReactionMode, NewsletterViewRole, NewsletterFetchedUpdate } from '../Types';
import { BinaryNode } from '../WABinary';
export declare const makeNewsletterSocket: (config: SocketConfig) => {
    newsletterQuery: (jid: string, type: "get" | "set", content: BinaryNode[]) => Promise<any>;
    newsletterWMexQuery: (jid: string | undefined, query_id: QueryIds, content?: object) => Promise<any>;
    ...
    fetchUserLid: (...jids: string[]) => Promise<import("..").USyncQueryResultList[] | undefined>;
