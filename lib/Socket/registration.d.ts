...
export declare const makeRegistrationSocket: (config: SocketConfig) => {
    ...
    newsletterQuery: (jid: string, type: "get" | "set", content: import("../WABinary").BinaryNode[]) => Promise<any>;
    newsletterWMexQuery: (jid: string | undefined, query_id: import("../Types").QueryIds, content?: object) => Promise<any>;
