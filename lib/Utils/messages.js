...
const generateWAMessageContent = async (message, options) => {
    ...
    if ('text' in message) {
        ...
        (_1 = message.poll).selectableCount || (_1.selectableCount = 0);
        (_2 = message.poll).toAnnouncementGroup || (_2.toAnnouncementGroup = false);
        ...
        if ((_f = message === null || message === void 0 ? void 0 : message.requestPayment) === null || _f === void 0 ? void 0 : _f.sticker) {
            ...
            notes = {
                extendedTextMessage: {
                    ...
                    contextInfo: {
                        stanzaId: (_j = (_h = options === null || options === void 0 ? void 0 : options.quoted) === null || _h === void 0 ? void 0 : _h.key) === null || _j === void 0 ? void 0 : _j.id,
                        participant: (_l = (_k = options === null || options === void 0 ? void 0 : options.quoted) === null || _k === void 0 ? void 0 : _k.key) === null || _l === void 0 ? void 0 : _l.participant,
                        quotedMessage: (_m = options === null || options === void 0 ? void 0 : options.quoted) === null || _m === void 0 ? void 0 : _m.message,
                        ...(_o = message === null || message === void 0 ? void 0 : message.requestPayment) === null || _o === void 0 ? void 0 : _o.contextInfo,
                    }
                }
            };
        }
        m.requestPaymentMessage = Types_1.WAProto.Message.RequestPaymentMessage.fromObject({
            ...
            noteMessage: { ...notes },
            background: (_p = message.requestPayment.background) !== null && _p !== void 0 ? _p : null,
        });
    }
    ...
    if ('interactiveButtons' in message && !!message.interactiveButtons) {
        ...
        if ('text' in message) {
            ...
            header: interactiveMessage.header = {
                ...
                hasMediaAttachment: (_q = message === null || message === void 0 ? void 0 : message.media) !== null && _q !== void 0 ? _q : false,
            };
        }
        else {
            if ('caption' in message) {
                ...
                header: interactiveMessage.header = {
                    title: message.title,
                    subtitle: message.subtitle,
                    hasMediaAttachment: (_r = message === null || message === void 0 ? void 0 : message.media) !== null && _r !== void 0 ? _r : false,
                };
    ...
    if ('shop' in message && !!message.shop) {
        ...
        if ('text' in message) {
            ...
            header: interactiveMessage.header = {
                title: message.title,
                subtitle: message.subtitle,
                hasMediaAttachment: (_s = message === null || message === void 0 ? void 0 : message.media) !== null && _s !== void 0 ? _s : false,
            };
        }
        else {
            if ('caption' in message) {
                ...
                header: interactiveMessage.header = {
                    title: message.title,
                    subtitle: message.subtitle,
                    hasMediaAttachment: (_t = message === null || message === void 0 ? void 0 : message.media) !== null && _t !== void 0 ? _t : false,
                };
                Object.assign(interactiveMessage.header, m);
            }
        }
    ...
    if ('collection' in message && !!message.shop) {
        const interactiveMessage = {
            collectionMessage: Types_1.WAProto.Message.InteractiveMessage.CollectionMessage.fromObject({
                bizJid: (_u = message === null || message === void 0 ? void 0 : message.collection) === null || _u === void 0 ? void 0 : _u.bizJid,
                id: (_v = message === null || message === void 0 ? void 0 : message.collection) === null || _v === void 0 ? void 0 : _v.id,
                messageVersion: (_w = message === null || message === void 0 ? void 0 : message.collection) === null || _w === void 0 ? void 0 : _w.version
            })
        };
        if ('text' in message) {
            body: interactiveMessage.body = {
    ...
    if ('cards' in message && !!message.cards) {
        ...
        if ('text' in message) {
            ...
            header: interactiveMessage.header = {
                title: message.title,
                subtitle: message.subtitle,
                hasMediaAttachment: (_z = message === null || message === void 0 ? void 0 : message.media) !== null && _z !== void 0 ? _z : false,
            };
        }
        if ('footer' in message && !!message.footer) {
            footer: interactiveMessage.footer = {
    ...
    if ('mentions' in message && ((_0 = message.mentions) === null || _0 === void 0 ? void 0 : _0.length)) {
...
const generateWAMessageFromContent = (jid, message, options) => {
    ...
    if (quoted && !(0, WABinary_1.isJidNewsletter)(jid)) {
        ...
        ((_m = (_l = innerMessage === null || innerMessage === void 0 ? void 0 : innerMessage.requestPaymentMessage) === null || _l === void 0 ? void 0 : _l.noteMessage) === null || _m === void 0 ? void 0 : _m.extendedTextMessage) ? (_q = (_p = (_o = innerMessage === null || innerMessage === void 0 ? void 0 : innerMessage.requestPaymentMessage) === null || _o === void 0 ? void 0 : _o.noteMessage) === null || _p === void 0 ? void 0 : _p.extendedTextMessage) === null || _q === void 0 ? void 0 : _q.contextInfo : ((_s = (_r = innerMessage.requestPaymentMessage) === null || _r === void 0 ? void 0 : _r.noteMessage) === null || _s === void 0 ? void 0 : _s.stickerMessage) ? (_v = (_u = (_t = innerMessage.requestPaymentMessage) === null || _t === void 0 ? void 0 : _t.noteMessage) === null || _u === void 0 ? void 0 : _u.stickerMessage) === null || _v === void 0 ? void 0 : _v.contextInfo : innerMessage[key].contextInfo = contextInfo;
    }
    if (
